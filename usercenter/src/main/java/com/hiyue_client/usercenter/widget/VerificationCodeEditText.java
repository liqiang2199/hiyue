package com.hiyue_client.usercenter.widget;

/**
 * com.xiudian_overseas.use_center.widget
 * XD111
 * 2019/5/21
 * 五月
 * 五月
 * XiuDian_OverseasClient
 */
...
public class VerificationCodeEditText extends android.support.v7.widget.AppCompatEditText implements
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, com.jkb.vcedittext.R.styleable.VerCodeEditText);
        mFigures = ta.getInteger(com.jkb.vcedittext.R.styleable.VerCodeEditText_figures, 4);
        mVerCodeMargin = (int) ta.getDimension(com.jkb.vcedittext.R.styleable.VerCodeEditText_verCodeMargin, 0);
        mBottomSelectedColor = ta.getColor(com.jkb.vcedittext.R.styleable.VerCodeEditText_bottomLineSelectedColor,
                getCurrentTextColor());
        mBottomNormalColor = ta.getColor(com.jkb.vcedittext.R.styleable.VerCodeEditText_bottomLineNormalColor,
                getColor(android.R.color.darker_gray));
        mBottomLineHeight = ta.getDimension(com.jkb.vcedittext.R.styleable.VerCodeEditText_bottomLineHeight,
                dp2px(5));
        mSelectedBackgroundColor = ta.getColor(com.jkb.vcedittext.R.styleable.VerCodeEditText_selectedBackgroundColor,
                getColor(android.R.color.darker_gray));
        mCursorWidth = (int) ta.getDimension(com.jkb.vcedittext.R.styleable.VerCodeEditText_cursorWidth, dp2px(1));
        mCursorColor = ta.getColor(com.jkb.vcedittext.R.styleable.VerCodeEditText_cursorColor, getColor(android.R.color.darker_gray));
        mCursorDuration = ta.getInteger(com.jkb.vcedittext.R.styleable.VerCodeEditText_cursorDuration, DEFAULT_CURSOR_DURATION);
        ta.recycle();
